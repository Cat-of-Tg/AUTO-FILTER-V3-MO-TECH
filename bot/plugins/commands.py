                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        ...
                        [
                            InlineKeyboardButton
                                (
                                    ' Movie Group', url=f"{MT_BOT_UPDATES}"
                                )
                        ]
                    ]
                )
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton
                                (
                                    'Group', url="https://t.me/MOvie_X_Zone"
                                )
                        ]
                    ]
                )
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton
                                (
                                    'MOVIE GROUP', url="https://t.me/MOvie_X_Zonr"
                                )
                        ]
                    ]
                )
...
async def about(bot, update):
    ...
    buttons = [[
        InlineKeyboardButton('MOVIE GOUP', url='https://t.me/Movie_X_Zone'),
        InlineKeyboardButton('OWNER', url='https://t.me/cat_of_tg')
    ],[
        InlineKeyboardButton('ALBERT', url='https://t.me/AlbertEinsteinTG')
    ],[
        InlineKeyboardButton('HOME', callback_data='start'),
        InlineKeyboardButton('CLOSE', callback_data='close')
    ]]
